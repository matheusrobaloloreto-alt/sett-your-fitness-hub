...
const PublicIntercycleAnamnesis = lazy(() => import("./pages/PublicIntercycleAnamnesis"));
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route path="/anamnese-interciclos/:token" element={<RouteTransition><PublicIntercycleAnamnesis /></RouteTransition>} />
          ...
          <Route path="/admin/questionarios" element={<Navigate to="/admin/registration" replace />} />
          ...
          <Route path="/coordinator/questionarios" element={<Navigate to="/coordinator/registration" replace />} />
