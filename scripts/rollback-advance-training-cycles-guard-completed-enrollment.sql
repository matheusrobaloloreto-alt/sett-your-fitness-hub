-- Rollback for 20260909165547_guard_completed_enrollment_cycles.sql.
--
-- Restores the exact live advance_training_cycles function captured in
-- /tmp/sett-renewal-schema-20260909.sql lines 294-366, plus its live comment.
-- Expected validation after rollback: the guard canary should fail with
-- advance_guard_mutated_completed_current_cycle.
