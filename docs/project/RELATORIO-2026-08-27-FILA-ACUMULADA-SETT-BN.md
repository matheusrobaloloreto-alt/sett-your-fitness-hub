...
| Desempenho aluno/professor | ✅ Produção e amostra autenticada; ❌ p75 de campo (em andamento) | O detalhe do aluno levava 2,44–3,12 s antes da correção. Em produção, aluno/matrícula iniciam juntos, o cabeçalho aparece antes dos ciclos e vídeos opcionais não bloqueiam a ficha. Em 12 recargas aquecidas autenticadas, o app do aluno teve p75 de 724 ms para o shell e 944 ms para o treino completo (máximo 980 ms); o painel de conversas do treinador teve p75 de 1.154 ms (faixa 1.033–1.203 ms). A telemetria RUM sem nome, aluno, treino, conversa, URL ou conteúdo está implementada localmente, validada para staff multiempresa e passou 6/6 testes focados, 99 arquivos/661 testes completos, lint, build, `dry-run` e QA independente; aguarda promoção para começar a formar o p75 de campo. |
